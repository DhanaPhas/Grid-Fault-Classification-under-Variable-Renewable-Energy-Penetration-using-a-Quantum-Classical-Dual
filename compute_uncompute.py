...
# Modified by Dhana Phassadawongse <dhana.p_s24@vistec.ac.th> for using valid transpiled backend 
"""
    ...
    **Reference:**
    ...
    def __init__(
        ...
        *,
        ...
        self._local = local
        ### MOD 3
        self._default_options = Options(); self.backend = backend
    ...
    def _run(
        ...
        **options,
        ...
        ### MOD 4
        print('Start transpile circuits')
        #### MOD 4.0.1
        circuits = transpile(circuits, backend=self.backend, basis_gates=['id', 'rz', 'sx', 'x', 'cx', 'reset']) #transpile manually
        print('End transpile circuits')
        ### MOD 4.1 with comment from prof.Steve
